...
//1.state of the app should change from weather empty to
//weather loading when filling text field is finished

//2.Displays a progress indicator when the state of
//the application is weather loading

//3.Displays a widget containing weather information when
//the state of the application is weather loaded
  testWidgets(
  ...
  testWidgets(
    ...
    (widgetTester) async {
      ...
      await widgetTester.pumpWidget(
        makeTestableWidget(const WeatherPage()),
      );
